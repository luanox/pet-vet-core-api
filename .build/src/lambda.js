...
function bootstrapServer() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!cachedServer) return [3, 3];
                    expressApp = express();
                    return [4, core_1.NestFactory.create(app_module_1.AppModule, new platform_express_1.ExpressAdapter(expressApp))];
                case 1:
                    nestApp = _a.sent();
                    nestApp.use(middleware_1.eventContext());
                    return [4, nestApp.init()];
                case 2:
                    _a.sent();
                    cachedServer = aws_serverless_express_1.createServer(expressApp, undefined, binaryMimeTypes);
                    _a.label = 3;
                case 3: return [2, cachedServer];
            }
        });
    });
}
var handler = function (event, context) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, bootstrapServer()];
            case 1:
                cachedServer = _a.sent();
                return [2, aws_serverless_express_1.proxy(cachedServer, event, context, 'PROMISE').promise];
        }
    });
}); };
